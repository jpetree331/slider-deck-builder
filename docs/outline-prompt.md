...
The user message carries `topic` and `source_notes` **verbatim** (Sacred Invariant 6), the slide-count instruction ("exactly N slides" when hinted, else "your choice, 6-12 slides"), and the user's style hints.
